...
print("2.1. - for Custom Status Line in global and hooks and mcp servers in project")
print("3. Command for open ~/.claude folder (in global) and deadcode (in project folder)")
